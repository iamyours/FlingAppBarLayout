...
import kotlinx.android.synthetic.main.activity_nested_scroll_fling.*

class NestedScrollFlingActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_nested_scroll_fling)
